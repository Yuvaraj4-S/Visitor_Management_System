...
<tr><td style="padding: 6px; border: 1px solid #d9e2ec;"><strong>Risk / SLA</strong></td><td style="padding: 6px; border: 1px solid #d9e2ec;">{{ doc.risk_level or 'N/A' }} / {{ doc.approval_sla_minutes or 'N/A' }} mins</td></tr>
