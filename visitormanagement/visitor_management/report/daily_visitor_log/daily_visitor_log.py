...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": "Check-In", "fieldname": "checkin", "fieldtype": "Datetime", "width": 160},
        {"label": "Check-Out", "fieldname": "checkout", "fieldtype": "Datetime", "width": 160},
    ...
    data = frappe.db.sql(
        f"""
        SELECT vp.badge_number, vp.visitor_full_name AS visitor_name, vp.visitor_type,
